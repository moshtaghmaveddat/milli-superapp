# Design System: Milli SuperApp — Variation 3 "Obsidian Editorial Navy" (brand-anchored)
**Project ID:** milli-superapp-local (variation v3, design-md semantic synthesis)
